...
export default function ViewInstancePage() {
  ...
  const toggleStatus = async () => {
    ...
    const newStatusDB = data.status === "On" ? "Stopped" : "Running";
          ...
          <div className="overflow-hidden rounded-3xl bg-white p-6 shadow-md">
            <table className="w-full text-lg text-gray-700">
              <tbody>
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-4 font-semibold">IP Address</td>
                  <td className="flex items-center gap-2 py-4">
                    <Network size={20} className="text-purple-500" />
                    <span className="font-mono text-gray-900">{data.ip}</span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="py-4">
                    <button
                      ...
                      disabled={toggling}
                      className={`flex items-center gap-2 rounded-full px-8 py-2 font-medium text-white shadow-sm transition ${
                        data.status === "On"
